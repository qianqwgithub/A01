  ...
  render() {
    const children = [
      ...
      <div class="Wrap ztPage ztPack">
        <ul>
          <li ><img src={require('@/static/img/1_1_1.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_1_2.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_1_3.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_1_4.png')} alt="" /></li>
        </ul>
      </div>,
      //底部
      <Footer1
