  ...
  render() {
    const children = [
      ...
      <div class="Wrap ztPage ztPack">
        <ul>
          <li ><img src={require('@/static/img/1_1.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_2.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_3.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_4.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_5.png')} alt="" /></li>
          <li ><img src={require('@/static/img/1_6.png')} alt="" /></li>
        </ul>
      </div>,
      //底部
      <Footer1
