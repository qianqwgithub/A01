  ...
  render() {
    const children = [
      ...
      <div class="Wrap ztPage ztPack">
        <ul>
          <li ><img src={require('@/static/img/5_1.png')} alt="" /></li>
          <li ><img src={require('@/static/img/5_2.png')} alt="" /></li>
          <li ><img src={require('@/static/img/5_3.png')} alt="" /></li>
          <li ><img src={require('@/static/img/5_4.png')} alt="" /></li>
          <li ><img src={require('@/static/img/5_5.png')} alt="" /></li>
        </ul>
      </div>,
      //底部
      <Footer1
